...
from utils import compute_metrics, save_results, set_seed, TEXT2LABEL
...
def evaluate(cfg):
    ...
    for i, idx in enumerate(val_indices):
        ...
        generated = processor.decode(out[0][inputs["input_ids"].shape[1]:], skip_special_tokens=True).strip().upper()
